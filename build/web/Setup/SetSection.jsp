<%-- 
    Document   : SetSection
    Created on : 19 Apr, 2018, 5:41:27 PM
...
<html lang="en-us">	
    <head>
        <meta charset="utf-8">
        <title>Set Section | Progressive Hostel</title>
        ...
        <script src="setSection.js"></script>
    </head>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <header class="MainHeader">
                        <span class="widget-icon"> <i style="display:inline" class="fa fa-edit"></i><h2 style="display:inline"> Add Section</h2> </span>
                    ...
                    <div>
                        ...
                        <div class="widget-body no-padding">
                            <form action="/ProgressiveHostel/AddSection" id="order-form" class="smart-form">
                                <fieldset>
                                    <div class="row">
                                        <section class="col col-6">
                                            <label class="input"> <i class="icon-append fa fa-mortar-board "></i>
                                                <input type="text" name="SECTION_NAME" placeholder="Add Section" onblur="checkSectionAvailablity(this.value)">
                                                <span id="checkSectionAvailMsg" style="color:red;">Section Name Not Available</span>
                                            </label>
                                        </section>
                                    </div>                               
                                </fieldset>
                ...
                <div class="container-fluid">
                    <header class="MainHeader">
                        <span class="widget-icon"> <i style="display:inline" class="fa fa-table"></i><h2 style="display:inline"> View Section</h2> </span>
                    </header>
                    <!-- widget div-->
                    <div>
                        <!-- widget edit box -->
