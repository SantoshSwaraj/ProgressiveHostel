...
<html lang="en-us">	
    ...
    <body class="smart-style-0">
            ...
            <nav>
                ...
                <ul>
                    <li class="">
                        ...
                        <ul>
                            <li class="">
                                <a href="ajax/dashboard.html" title="Dashboard"><span class="menu-item-parent">Analytics</span></a>
                            </li>
                            <li class="">
                                <a href="ajax/dashboard-marketing.html" title="Marketing"><span class="menu-item-parent">Marketing</span></a>
                            </li>
                            <li class="">
                                <a href="ajax/dashboard-social.html" title="Social"><span class="menu-item-parent">Social Wall</span></a>
                            </li>
                        </ul>	
                    </li>
                    ...
                    <li>
                        ...
                        <ul>
                            <li>
                                ...
                                <ul>
                                    <li><a href="landing/option-1/index.html" target="_blank">Option 1</a></li>
                                    <li><a href="landing/option-2/index.html" target="_blank">Option 2</a></li>
                                    <li><a href="landing/option-3/index.html" target="_blank">Option 3</a></li>
                                </ul>
                            </li>
                            <li>
        ...
        <script src="assests/js/plugin/bootstrap-slider/bootstrap-slider.min.js"></script>
