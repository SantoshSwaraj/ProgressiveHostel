<%-- 
    Document   : UpdateHostelMonthlyFeeAgainForm
    Created on : 30 Apr, 2018, 1:10:51 PM
...
<html lang="en-us">	
    <head>
        <meta charset="utf-8">
        <title>Update Hostel Monthly Fee Form | Progressive Hostel</title>
                ...
                <div class="container-fluid">
                    ...
                    <div>
                        ...
                        <div class="widget-body no-padding">
                            <!--form starts-->
                            <form  id="jvalidate1" role="form" class="form-horizontal" action="/ProgressiveHostel/UpdateHostelMonthlyFeeLedgerAgain" method="post" autocomplete="off">
                                ...
                                <div class="form-group">
                                    <div class="col-md-6">
                                        ...
                                        <%
                                            int TOTAL_TO_PAY = hostelMonthlyFeeLedgerBean.getBALANCE_AMT();
                                        %>
