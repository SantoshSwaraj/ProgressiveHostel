<%-- 
    Document   : OneTimeChargeForm
    Created on : 27 Apr, 2018, 7:08:44 PM
...
<html lang="en-us">	
    <head>
        <meta charset="utf-8">
        <title>One Time Charge Form | Progressive Hostel</title>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <header class="MainHeader">
                        <span class="widget-icon"> <i style="display:inline" class="fa fa-edit"></i><h2 style="display:inline">One Time Charge Form</h2></span>
                    ...
                    <div>
                        ...
                        <div class="widget-body no-padding">          
                            <form action="/ProgressiveHostel/SearchRegistratedStudent" method="POST" id="addClass-form" class="smart-form">
                                <fieldset>
                                    <div class="row">
