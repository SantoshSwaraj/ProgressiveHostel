<%-- 
    Document   : SetMonthlyCharge
    Created on : 19 Apr, 2018, 5:43:47 PM
...
<html lang="en-us">	
    <head>
        <meta charset="utf-8">
        <title>Set Monthly Charge | Progressive Hostel</title>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <header class="MainHeader">
                        <span class="widget-icon"> <i style="display:inline" class="fa fa-edit"></i><h2 style="display:inline"> Add Class Wise Monthly Charge</h2> </span>
                    ...
                    <div>
                        ...
                        <div class="widget-body no-padding">
                            <form action="/ProgressiveHostel/AddClassHostelMonthlyFee" id="AddClassHostelMonthlyFee" class="smart-form">
                                <fieldset>
                                    <div class="row">
                                        ...
                                        <section class="col col-6">
                                            <label class="input"> <i class="icon-append fa fa-inr"></i>
                                                <input type="text" name="FEE" id="FEE" placeholder="Enter Monthly Charge Amount" onblur="checkClassHostelMonthlyFeeAvailablity()">
                                                <span id="checkMsg" style="color:red;">Class Hostel Fee Already Exist</span>
                                            </label>
                                        </section>
                                    </div>                               
                                </fieldset>
